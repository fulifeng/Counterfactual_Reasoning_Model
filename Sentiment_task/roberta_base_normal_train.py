...
parser.add_argument("--save_folder", type=str, default="./roberta_base_normal_train/")
...
orig_test_max = 0
setup_seed(seed)
model = AutoModelForSequenceClassification.from_pretrained("roberta-base", num_labels = 2, from_tf = True).to(device)
...
for i in range(0, args.epochs): 
    ...
    if acc4 >= orig_val_max:
        orig_val_max = acc2
        orig_test_max = acc3
        torch.save(model, final_save_folder + "/roberta-base"  + ".pt")
