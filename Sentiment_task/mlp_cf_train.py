...
parser.add_argument("--save_folder",type=str,default="./mlp_cf/")
...
for i in range(args.epoch):
    ...
    with open(result_path + "/acc_list", 'a+') as f:
        f.write("epoch:"+str(i)+"  train_acc:"+str(train_acc)+" total_valid_acc:"+str(valid_acc)+" orig_test_acc:"+str(test_acc) + " loss_total:" + str(loss)  +
            " total_valid_max:"+str(max(valid_acc_list))+" in that epcoh, the orig_test_acc is:"+str(test_acc_list[valid_acc_list.index(max(valid_acc_list))])+ "\n")
