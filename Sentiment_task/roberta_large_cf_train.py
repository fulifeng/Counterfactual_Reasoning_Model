...
parser.add_argument("--save_folder", type=str, default="./roberta_large_cf_train/")
...
for i in range(0, args.epochs): 
    ...
    if i == args.epochs - 1:
        with open(args.save_folder + "/" + "final_acc", "a+") as f:
            f.write("random seed:" + str(seed) + "total_val_max: " + str(total_val_max) + "orig_test_acc: "+ str(orig_test_max) + "\n")
