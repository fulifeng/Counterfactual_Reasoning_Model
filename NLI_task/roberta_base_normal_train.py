...
parser.add_argument("--save_folder", type=str, default="./NLI_tasks/roberta_base_normal_train/")
...
orig_test_max = 0
setup_seed(seed)
model = AutoModelForSequenceClassification.from_pretrained("roberta-base", num_labels = 3, from_tf = True).to(device)
